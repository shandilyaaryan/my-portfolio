...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Aryan Shandilya
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className='home__description'>Full stack developer skilled in React and Node.js, handling both front-end and back-end development for complete web solutions.</p>
